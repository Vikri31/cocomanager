      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _buildSmallCard('Penjualan hari ini', todaySalesStr, const Color.fromARGB(255, 42, 184, 147)),
                const SizedBox(width: 15),
                _buildSmallCard('Sisa stok kelapa', currentStockStr, stockCardColor),
              ],
            ),
          ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    SizedBox(height: 200, child: LineChart(mainData(provider.todayHourlySales))),
                  ],
                ),
              ),
            ),
        ...
        bottomTitles: AxisTitles(
          sideTitles: SideTitles(
            ...
            getTitlesWidget: (value, meta) {
              ...
              if (hour >= 6 && hour <= 18) {
                return Text('${hour.toString().padLeft(2, '0')}:00', style: const TextStyle(fontSize: 10));
              }
              return const Text('');
            },
          ),
...
class _QuickSaleFormState extends State<QuickSaleForm> {
  ...
  void initState() {
    super.initState();
    _pricePerUnitController = TextEditingController(text: widget.defaultPrice.toString());
  ...
  @override
  Widget build(BuildContext context) {
    final currentStock = context.watch<TransactionProvider>().currentStockKelapa;
      ...
      child: Form(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Penjualan Cepat', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ...
              TextFormField(
                ...
                validator: (val) {
                  ...
                  if (qty > currentStock) return 'Stok tidak cukup! (Sisa: $currentStock)';
                  return null;
                },
              ),
              Row(
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Harga per biji (Rp)'),
                      keyboardType: TextInputType.number,
                    ),
                  ),
                  const SizedBox(width: 15),
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Harga Total (Rp)'),
                      keyboardType: TextInputType.number,
                      validator: (val) => val!.isEmpty ? 'Wajib diisi' : null,
                    ),
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Simpan Penjualan', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ),
              const SizedBox(height: 20),
            ],
